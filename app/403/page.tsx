...
import { Compass, ShieldX, Home } from 'lucide-react';
    ...
    <div className="flex-1 min-h-screen flex flex-col items-center justify-center bg-[#09090B] relative py-12 px-4 sm:px-6 lg:px-8 select-none text-center">
      ...
      <div className="relative z-10 max-w-md space-y-6">
        ...
        <div className="space-y-2">
          ...
          <h1 className="text-3xl font-extrabold font-display text-white tracking-tight mt-4">Access Forbidden</h1>
          <p className="text-xs sm:text-sm text-text-muted leading-relaxed max-w-sm mx-auto mt-2">
            Your user credentials do not have the permissions required to view this directory block. Contact system administrator if this is an error.
          </p>
        </div>
        ...
        <div className="pt-2 flex justify-center">
          <Link
            href="/dashboard"
            className="px-6 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-xs font-semibold text-white rounded-lg transition-colors flex items-center justify-center gap-2 border border-zinc-700"
          >
