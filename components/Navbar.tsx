          ...
          {showProfile && (
            <div className="absolute right-0 mt-2 w-56 bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl overflow-hidden py-1 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
              <div className="px-4 py-3 border-b border-zinc-800">
                <p className="text-xs font-semibold text-white">Kirandeep Gudepu</p>
                <p className="text-[10px] text-text-muted truncate">kirandeep@university.edu</p>
              </div>
              <div className="py-1">
                <button className="w-full text-left px-4 py-2 text-xs text-text-muted hover:text-white hover:bg-zinc-950 transition-colors flex items-center justify-between">
                  <span>Profile Settings</span>
                </button>
                <button className="w-full text-left px-4 py-2 text-xs text-text-muted hover:text-white hover:bg-zinc-950 transition-colors flex items-center justify-between">
                  <span>My Resume</span>
                  <span className="text-[9px] bg-primary/20 text-primary font-bold px-1.5 py-0.5 rounded">Tailored</span>
                </button>
              </div>
              <div className="border-t border-zinc-800 py-1">
                <button className="w-full text-left px-4 py-2 text-xs text-danger hover:bg-zinc-950 transition-colors">
                  Log out
                </button>
              </div>
            </div>
