...
async function main() {
  ...
  const opportunitiesData = [
    ...
    },
    {
      ...
      applicationUrl: 'https://careers.google.com/jobs/results/?q=apm',
    ...
    // Microsoft (4)
    {
      ...
      applicationUrl: 'https://apply.careers.microsoft.com/careers?query=Explore',
    ...
    },
    {
      ...
      applicationUrl: 'https://apply.careers.microsoft.com/careers?query=Software+Engineer',
    ...
    // Amazon (2)
    {
      ...
      applicationUrl: 'https://www.amazon.jobs/content/en/career-programs/university',
      deadline: new Date('2026-11-30'),
    ...
    // Netflix (1)
    {
      ...
      applicationUrl: 'https://jobs.netflix.com/teams/engineering',
      deadline: new Date('2026-09-30'),
