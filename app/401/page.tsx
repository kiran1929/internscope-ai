...
import { Compass, ShieldAlert, LogIn } from 'lucide-react';
    ...
    <div className="flex-1 min-h-screen flex flex-col items-center justify-center bg-[#09090B] relative py-12 px-4 sm:px-6 lg:px-8 select-none text-center">
      ...
      <div className="relative z-10 max-w-md space-y-6">
        ...
        <div className="space-y-2">
          <div className="w-14 h-14 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center mx-auto text-amber-500 shadow-lg shadow-amber-500/5">
            <ShieldAlert className="w-7 h-7" />
          </div>
          <h1 className="text-3xl font-extrabold font-display text-white tracking-tight mt-4">Unauthenticated</h1>
          <p className="text-xs sm:text-sm text-text-muted leading-relaxed max-w-sm mx-auto mt-2">
            You must be logged in to access this page. Your active authentication session has expired or is invalid.
          </p>
        </div>
        ...
        <div className="pt-2 flex justify-center">
          <Link
            href="/sign-in"
            className="px-6 py-2.5 bg-primary hover:bg-blue-700 text-xs font-bold text-white rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/10"
          >
