    ...
    <div className="flex flex-col items-center justify-center min-h-[40vh] p-6 text-center select-none">
      <div className="bg-[#111113] border border-zinc-800/80 rounded-xl p-8 max-w-sm w-full space-y-4">
        <div className="flex flex-col items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-white uppercase tracking-wider">Failed to Load Opportunities</h3>
          <p className="text-[11px] text-text-muted">Could not query the opportunity datasets from Neon. Please check database status.</p>
        </div>
